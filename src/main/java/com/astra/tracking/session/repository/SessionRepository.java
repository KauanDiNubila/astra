package com.astra.tracking.session.repository;
...
import com.astra.tracking.session.entity.Session;
...
public interface SessionRepository extends JpaRepository<Session, UUID> {
    ...
    @Query("""
            select new com.astra.tracking.session.dto.UserMinutes(s.userId, sum(s.focusedMinutes))
            from Session s
